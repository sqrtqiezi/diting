...
from diting.services.storage.checkpoint import CheckpointManager
from diting.services.storage.jsonl_reader import read_jsonl_stream
from diting.services.storage.message_normalizer import MessageNormalizer
...
def incremental_ingest(
    ...
    for message in read_jsonl_stream(jsonl_file, start_line=start_line):
        ...
        if len(messages) >= batch_size:
            ...
            # 保存检查点
            from diting.models.checkpoint import ProcessingCheckpoint
